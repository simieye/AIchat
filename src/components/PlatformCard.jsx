...
// @ts-ignore;
import { CheckCircle, XCircle, RefreshCw, Settings, ExternalLink, Globe, Video, Users, MessageSquare, ShoppingBag, BookOpen, Music } from 'lucide-react';
        ...
        <div className="space-y-4">
          <div className="flex items-center gap-4 text-sm">
            ...
            <div className="flex items-center gap-1">
              ...
              <span>{platform.category.replace('_', ' ')}</span>
            </div>
